...
class Utils {
    class func showMessage(_ message: String) {
        // An alert is presented in the topmost keyWindow
...
extension UITextField {
    func customize(_ transparent: Bool) {
        // The text field is customized with border width, corner radius, and color.
